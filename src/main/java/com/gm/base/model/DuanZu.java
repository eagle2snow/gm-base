...
@M("短租房")
@Entity(name = "duanzu")
@Table(name = "aj_duanzu")
public class DuanZu extends Model {
	...
	@FormField(type = FieldType.TEXTINPUT, label = "日租")
	private BigDecimal price; // 月租
	@FormField(type = FieldType.TEXTINPUT, label = "押")
	private Integer ya;// 押金
	@FormField(type = FieldType.TEXTINPUT, label = "床位")
	private String bed = "0";// 床位
	@FormField(type = FieldType.TEXTINPUT, label = "起租天数")
	private Integer mixDay;// 起租天数
	...
	@FormField(type = FieldType.CHECKBOX, label = "配套", data = "1|冰箱,2|空调,3|洗衣机,4|热水器,5|电视,6|宽带,7|沙发,8|床,9|衣柜,10|独立卫生间,11|阳台,12|暖气,13|车位")
	...
	public Integer getMixDay() {
		return mixDay;
	}

	public void setMixDay(Integer mixDay) {
		this.mixDay = mixDay;
	}
